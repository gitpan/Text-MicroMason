...
calls, and containing less than a thousand lines of Perl code.
...
The level of Mason compatibility is described in L<Text::MicroMason::Mason>.
...
by L<Embperl|Embperl>, L<HTML::Template|HTML::Template> and
L<Text::Template|Text::Template>.  Because these modules share the
underlying implementation of compiling a custom Perl subroutine, they
theoretically could execute faster than the run-time evaluation mechanisms
used by the originals, although no benchmarking has been performed yet.


=head1 DISTRIBUTION

This is version 1.96_0 of Text::MicroMason. 

This is an EXPERIMENTAL version on a development track for a 2.0 release.
...
(C<http://cpanratings.perl.org/rate/?distribution=Text-MicroMason>).
