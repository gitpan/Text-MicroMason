...
calls, and containing just a few hundred lines of Perl code.
...
Expression filtering with |h and |u (via -Filter option)
...
%args, %perl, %once, %init, %cleanup, and %doc blocks
...
This is version 1.9_0 of Text::MicroMason. 
