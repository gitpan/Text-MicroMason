...
Text::MicroMason::Changes - Change History for the MicroMason Distribution
...
Setup a benchmarking scheme to compare subclasses with other templating solutions. Take an example from http://www.chamas.com/bench/ but execute templates directly. Store the expected output in a text file for comparison.
